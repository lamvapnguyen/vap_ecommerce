...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <input type="button" value="Add" id="addRoleButt" onclick="window.location.href=('/M0110/Add')"
            tabindex="1" class="btn" <%=Html.Encode(Session["CommonIsReadOnly"])%> />
        <input type="submit" value="Edit" id="detailButt" name="Edit" tabindex="2" class="btn"
            <%=Html.Encode(Session["CommonIsReadOnly"])%> />
        <table class="data-table">
            <tr>
                <th scope="col" class="th30">
                    Select
                </th>
            ...
            <tr <%=evenRow %>>
                <td class="textAlignCenter">
                    <input type="checkbox" name="roleCds" id="roleCds" value="<%=role.ROLE_CD%>" class="unique"
                        tabindex="3" />
                </td>
                <td>
